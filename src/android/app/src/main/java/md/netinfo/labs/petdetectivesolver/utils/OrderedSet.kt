 ...
 * An Ordered set is also sometimes used as an alternative to a hash map, for example in STL’s map.
 * Taken from https://chercher.tech/kotlin/ordered-set-kotlin
 */
